...
- :material-docker:{ .xl .middle } **Docker**
    ...
    ***
    ...
    Use a container engine such as [Docker](https://www.docker.com/) or [Podman](https://podman.io/) and their `composer` to run a complete, secure, isolated, and easy-to-update instance of Open Voice OS!
